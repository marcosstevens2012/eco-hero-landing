...
import { Truck, FileX, Recycle, Milk } from "lucide-react";

const ServiceCard = ({ icon: Icon, iconBg, title, description, delay }: { icon: any; iconBg: string; title: string; description: string; delay: number }) => {
  return (
    <div className="service-card animate-fade-in" style={{ animationDelay: `${delay}ms` }}>
    ...
    <section id="services" className="py-20" ref={sectionRef}>
      <div className="section-container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-block py-1 px-3 rounded-full bg-primary/10 text-primary text-sm font-medium mb-4">Nuestros Servicios</div>
          <h2 className="heading-secondary mb-5">Soluciones completas para la gestión de residuos</h2>
          <p className="subheading">Ofrecemos un servicio integral para empresas que buscan gestionar sus residuos de manera sostenible y responsable.</p>
        </div>
