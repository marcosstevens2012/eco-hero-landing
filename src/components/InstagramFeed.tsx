...
const InstagramFeed = () => {
  ...
  const [posts, setPosts] = useState<InstagramPost[]>([
    ...
    {
      id: "6",
      imageUrl: "/lovable-uploads/roto3.jpeg",
      caption: "¿Sabías que reciclar una tonelada de papel salva 17 árboles? #DatosCuriosos #MedioAmbiente",
      likes: 112,
      link: "https://instagram.com/rotondaro_recicla",
    },
    ...
    <section id="instagram" className="py-20 bg-gradient-to-br from-white to-green-50">
      <div className="section-container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="heading-secondary mb-5">Nuestro trabajo en acción</h2>
          <p className="subheading">Conéctate con nosotros en las redes sociales y mantente al día con nuestros proyectos, consejos de reciclaje y más.</p>
        </div>

        <div className="relative max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-lg" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
          ...
          <div className="flex transition-transform duration-500 ease-in-out h-[500px]" style={{ transform: `translateX(-${currentIndex * 100}%)` }}>
            {posts.map((post) => (
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent text-white z-20">
                  <div className="flex justify-between items-center mb-2">
                    <div className="flex items-center space-x-2">
                      <img src="/lovable-uploads/533e3d34-7da3-4d76-8714-b09462fddf69.png" alt="Rotondaro Logo" className="w-8 h-8 rounded-full object-contain bg-white" />
                  ...
                  <a href={post.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center mt-3 text-xs text-white/90 hover:text-white">
        ...
        <div className="text-center mt-8">
          <a href="https://instagram.com/rotondaro_recicla" target="_blank" rel="noopener noreferrer" className="inline-flex items-center button-secondary">
