    ...
    <section id="contact" className="py-20">
      <div className="section-container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-block py-1 px-3 rounded-full bg-primary/10 text-primary text-sm font-medium mb-4">Contacto</div>
          <h2 className="heading-secondary mb-5">¿Listo para comenzar? Contáctanos hoy</h2>
          ...
          <div className="lg:col-span-2">
            <ContactInfo
              ...
              content={
                <div>
                  <p className="mb-2">
                    <strong>Compra de papel, cartón y PET en desuso:</strong>
                    <br />
                    Zum Felde 2274 - CP 11400. Montevideo
                    <br />
                    WhatsApp: 098 595 111
                  </p>
                  <p>
                    <strong>Venta de envases de vidrio:</strong>
                    <br />
                    Zum Felde 2301 - CP 11400. Montevideo
                    <br />
                    WhatsApp: 096 407 200
                  </p>
                </div>
              }
            />
            ...
            <ContactInfo
              ...
              content={
                <div>
                  ...
                  <p>WhatsApp: 098 595 111 (Compra materiales)</p>
                  <p>WhatsApp: 096 407 200 (Venta envases)</p>
                </div>
              }
            />

            <ContactInfo icon={Mail} title="Correo electrónico" content="reciclo@rotondaro.com.uy" />
            ...
            <ContactInfo
              ...
              content={
                <div>
                  <p>Lunes a viernes: 8:00 - 11:30 y 13:00 - 17:00</p>
                </div>
              }
            />
