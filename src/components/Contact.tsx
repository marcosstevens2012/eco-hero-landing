          ...
          <div className="lg:col-span-2">
            <ContactInfo 
              ...
              content={
                <div>
                  <p className="mb-2">
                    <strong>Compra de papel, cartón y PET en desuso:</strong><br />
                    Zum Felde 2274 - CP 11400. Montevideo<br />
                    WhatsApp: 098 595 111
                  </p>
                  <p>
                    <strong>Venta de envases de vidrio:</strong><br />
                    Zum Felde 2301 - CP 11400. Montevideo<br />
